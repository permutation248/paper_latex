...
\twocolumn[
\icmltitle{Automatically Identify and Rectify:  Deep Contrastive \\ Multi-view Clustering in Noisy Scenarios}
...
\centerline{\includegraphics[width=1\textwidth]{Figure/Ablation/decline_acc.pdf}}
\vspace{3pt}
{\centerline{ACC}}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\centerline{\includegraphics[width=\textwidth]{Figure/Ablation/decline_nmi.pdf}}
\vspace{3pt}
{\centerline{NMI}}
\end{minipage}
...
\centerline{\includegraphics[width=1\textwidth]{Figure/Ablation/01/BBCSport.pdf}}
{\centerline{BBCSport}}
\end{minipage}
\begin{minipage}{0.23\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Ablation/01/cal101.pdf}}
{\centerline{Caltech101}}
\end{minipage}
\begin{minipage}{0.23\linewidth}
\centerline{\includegraphics[width=\textwidth]{Figure/Ablation/01/stl10.pdf}}
{\centerline{STL10}}
\end{minipage}
\begin{minipage}{0.23\linewidth}
\centerline{\includegraphics[width=\textwidth]{Figure/Ablation/01/retu.pdf}}
{\centerline{Reuters}}
\end{minipage}
...
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_20.pdf}}
\vspace{5pt}
\centerline{{20 Epoch}}
\end{minipage}\hspace{5pt}
\begin{minipage}{0.22\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_80.pdf}}
\vspace{5pt}
\centerline{{80 Epoch}}
\end{minipage}\hspace{5pt}
\begin{minipage}{0.22\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_140.pdf}}
\vspace{5pt}
\centerline{{140 Epoch}}
\end{minipage}\hspace{5pt}
\begin{minipage}{0.22\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_200.pdf}}
\vspace{5pt}
...
\centerline{\includegraphics[width=1\textwidth]{Figure/tau/01/ACC_tau.pdf}}
% \vspace{5pt}
\centerline{{ACC}}
\end{minipage}\hspace{5pt}
\begin{minipage}{0.3\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/tau/01/NMI_tau.pdf}}
% \vspace{5pt}
\centerline{{NMI}}
\end{minipage}\hspace{5pt}
\begin{minipage}{0.3\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/tau/01/PUR_tau.pdf}}
% \vspace{5pt}
\centerline{{PUR}}
\end{minipage}\hspace{5pt}
...
\small
\begin{minipage}{0.23\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Sen/01/bbc_acc.pdf}}
{\centerline{BBCSport-ACC}}
\centerline{\includegraphics[width=1\textwidth]{Figure/Sen/01/bbc_nmi.pdf}}
{\centerline{BBCSport-NMI}}
% \centerline{\includegraphics[width=1\textwidth]{Figure/Sen/01/bbc_pur.pdf}}
% {\centerline{BBCSport-PUR}}
% \centerline{\includegraphics[width=1\textwidth]{Figure/Sen/01/cal_acc.pdf}}
% {\centerline{Caltech101}}
\end{minipage}
\begin{minipage}{0.23\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Sen/01/webkb_acc.pdf}}
{\centerline{WebKB-ACC}}
\centerline{\includegraphics[width=1\textwidth]{Figure/Sen/01/webkb_nmi.pdf}}
{\centerline{WebKB-NMI}}
% \centerline{\includegraphics[width=1\textwidth]{Figure/Sen/01/webkb_pur.pdf}}
% {\centerline{WebKB-PUR}}
% \centerline{\includegraphics[width=1\textwidth]{Figure/Sen/01/cal_pur.pdf}}
% {\centerline{Caltech101-PUR}}
\end{minipage}
\begin{minipage}{0.23\linewidth}
% \centerline{\includegraphics[width=\textwidth]{Figure/Sen/01/re_acc.pdf}}
% {\centerline{Reuters-ACC}}
\centerline{\includegraphics[width=\textwidth]{Figure/Sen/01/re_nmi.pdf}}
{\centerline{Reuters-NMI}}
% \centerline{\includegraphics[width=\textwidth]{Figure/Sen/01/re_pur.pdf}}
% {\centerline{Reuters-PUR}}
\centerline{\includegraphics[width=\textwidth]{Figure/Sen/01/cal_nmi.pdf}}
{\centerline{Caltech101-NMI}}
\end{minipage}
\begin{minipage}{0.23\linewidth}
\centerline{\includegraphics[width=\textwidth]{Figure/Sen/01/stl_pur.pdf}}
{\centerline{STL10-PUR}}
% \centerline{\includegraphics[width=\textwidth]{Figure/Sen/01/stl_acc.pdf}}
% {\centerline{STL10-ACC}}
% \centerline{\includegraphics[width=\textwidth]{Figure/Sen/01/stl_nmi.pdf}}
% {\centerline{STL10-NMI}}
\centerline{\includegraphics[width=\textwidth]{Figure/Sen/01/uci_nmi.pdf}}
...
\small
\begin{minipage}{0.45\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Ablation/01/webkb.pdf}}
{\centerline{WebKB}}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Ablation/01/uci.pdf}}
...
\centerline{\includegraphics[width=1\textwidth]{Figure/Ablation/03/bbc_03.pdf}}
{\centerline{BBCSport}}
\centerline{\includegraphics[width=1\textwidth]{Figure/Ablation/03/webkb_03.pdf}}
{\centerline{WebKB}}
\end{minipage}
\begin{minipage}{0.31\linewidth}
\centerline{\includegraphics[width=\textwidth]{Figure/Ablation/03/stl10_03.pdf}}
{\centerline{STL10}}
\centerline{\includegraphics[width=\textwidth]{Figure/Ablation/03/cal101_03.pdf}}
{\centerline{Caltech101}}
\end{minipage}
\begin{minipage}{0.31\linewidth}
\centerline{\includegraphics[width=\textwidth]{Figure/Ablation/03/retu_03.pdf}}
{\centerline{Reuters}}
\centerline{\includegraphics[width=\textwidth]{Figure/Ablation/03/uci_03.pdf}}
{\centerline{UCI-digit}}
\end{minipage}
...
\vspace{5pt}
\centerline{{20 Epoch}}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_120.pdf}}
\vspace{5pt}
\centerline{{120 Epoch}}
\end{minipage}\hspace{3pt}
\begin{minipage}{0.19\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_40.pdf}}
\vspace{5pt}
\centerline{{40 Epoch}}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_140.pdf}}
\vspace{5pt}
...
\end{minipage}\hspace{3pt}
\begin{minipage}{0.19\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_60.pdf}}
\vspace{5pt}
\centerline{{60 Epoch}}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_160.pdf}}
\vspace{5pt}
...
\vspace{5pt}
\centerline{{80 Epoch}}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_180.pdf}}
\vspace{5pt}
\centerline{{180 Epoch}}
\end{minipage}\hspace{3pt}
\begin{minipage}{0.19\linewidth}
\centerline{\includegraphics[width=1\textwidth]{Figure/Vis/vis_100.pdf}}
\vspace{5pt}
